...
let g:colors_name = "murphy_ch"

hi Normal		ctermbg=Black  ctermfg=lightgreen guibg=#002b36		 guifg=lightgreen
...
"set cc=80 列高亮的颜色，原始红色，太扎眼
hi ColorColumn  guibg=#073642
"设置光标所在行的颜色
hi CursorLine   guibg=#073642
"设置折叠行的颜色
hi Folded       guibg=#073642
"设置行号列的颜色
hi LineNr		term=underline ctermfg=Yellow		guifg=#657b83			guibg=#073642
